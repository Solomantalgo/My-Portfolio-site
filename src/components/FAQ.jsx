...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes - I work remotely across Uganda. All communication and file sharing happens on WhatsApp and Google Drive, so location does not matter. I've worked with businesses all over Uganda."
  }
];
      ...
      <div className="container">
        ...
        <div className="faq-grid reveal">
          {faqs.map((faq, i) => {
            ...
            return (
              <div key={faq.q} className={`faq-item-box${isOpen ? ' open' : ''}`}>
                <button
                  type="button"
                ...
                <div id={`faq-answer-${i}`} className="faq-a-text" hidden={!isOpen}>{faq.a}</div>
              </div>
            );
          })}
        </div>
