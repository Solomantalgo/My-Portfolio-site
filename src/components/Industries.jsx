const Industries = () => {
  const industries = [
    ...
    { icon: "👗", name: "Fashion", url: "https://fashion-demo.solomantalgo.online/", sub: "View Demo →" },
    { icon: "💪", name: "Gym & Fitness", url: "https://gym-demo.solomantalgo.online/", sub: "View Demo →" },
    { icon: "📷", name: "Photography", url: "https://photography-demo.solomantalgo.online/", sub: "View Demo →" },
    { icon: "💍", name: "Jewellery", url: "https://jewellery-demo.solomantalgo.online/", sub: "View Demo →" },
    { icon: "💅", name: "Nail Studio", url: "https://nails-demo.solomantalgo.online/", sub: "View Demo →" },
